...
describe('searcher.js: core search functionality', () => {
  it('finds matching lines in a single file', async () => {
  ...
  it('supports recursive searching in directories', async () => {
  ...
  it('filters files using filePattern', async () => {
    const { dirPath } = await setupFilestructure({
      'x.md': 'match\none',
      'y.txt': 'match',
      'a.log': 'skip',
